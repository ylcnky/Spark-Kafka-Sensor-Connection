...
if __name__ == "__main__":
    ...
    # Average temperature in each apartment 
    avgTempByState = jsonRDD.map(lambda x: (x['apartment'], (x['payload']['data']['temperature'], 1))) \
    ...
    # Number of devices in each apartment
    numSensorsByState = jsonRDD.map(lambda x: (x['apartment'] + ":" + x['guid'], 1)) \
